...
export function VisualWatermarkModal({ isOpen, docId, onClose, onApply }: VisualWatermarkModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex justify-center items-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl flex h-[80vh] overflow-hidden">
        ...
        <div className="w-80 border-l bg-white flex flex-col">
          <div className="p-4 border-b">
            ...
            <p className="text-xs text-gray-500 mt-1">Configure your watermark. It will be applied to all pages.</p>
          </div>
