...
def run_cuj(page):
    ...
    # Generate test pdf
    with open('/home/jules/test.pdf', 'wb') as f:
    ...
    page.locator('input[type="file"]').set_input_files("/home/jules/test.pdf")

    page.wait_for_timeout(2000)
    page.screenshot(path="/home/jules/verification/screenshots/pre-verification.png")
    ...
    page.screenshot(path="/home/jules/verification/screenshots/menu-verification.png")
